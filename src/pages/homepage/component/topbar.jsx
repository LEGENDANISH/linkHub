...
const Topbar = () => {
  ...
  return (
    <div className="fixed top-4 sm:top-6 left-1/2 -translate-x-1/2 w-[94%] sm:w-[90%] md:w-[85%] lg:w-[70%] z-50">
      ...
      <div className="bg-white/90 backdrop-blur-md shadow-lg rounded-full 
        ...
        <div className="hidden md:flex items-center gap-3">
          <button className="bg-[#f3f3f1] px-4 lg:px-5 py-2 rounded-xl 
                             text-sm lg:text-base font-semibold">
            Log in
          </button>

          <button className="bg-[#1e293b] text-white 
                             px-5 lg:px-6 py-2 rounded-full 
                             text-sm lg:text-base font-semibold 
