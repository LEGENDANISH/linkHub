...
import { X, Search, Lightbulb, ShoppingBag, Heart, Play, Contact, Calendar, FileText, MoreHorizontal, GripVertical, Pencil, Share2, Image, Star, Copy, Lock, BarChart3, Trash2 } from 'lucide-react';
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="font-semibold text-gray-900">{selectedLink}</span>
