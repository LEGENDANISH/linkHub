...
/**
 * Background Video Layer Component
 */
export function BackgroundVideoLayer({ design, videoRef }) {
  if (design.wallpaperStyle !== "video" || !design.backgroundVideo) {
    return null;
  }
...
/**
 * Blur Effect Layer Component
 */
export function BlurEffectLayer({ design }) {
  if (design.wallpaperStyle !== "blur") {
    return null;
  }
 ...
 */
export function PatternLayer({ design }) {
...
/**
 * Image Effects Layer Component
 */
export function ImageEffectsLayer({ design }) {
  if (design.wallpaperStyle !== "image" || !design.backgroundImage) {
    return null;
  }
...
/**
 * Noise Layer Component
 */
export function NoiseLayer({ design }) {
  if (!design.noise) {
    return null;
  }
